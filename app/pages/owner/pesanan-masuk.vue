<!-- app/pages/owner/pesanan-masuk.vue -->
<template>
        ...
        <header class="ticket-card p-5 md:p-6 space-y-5">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <span class="mono label-xs text-[#8A7A68]">PANTAUAN PESANAN MASUK</span>
                    </div>
                    <h1 class="display text-xl sm:text-2xl text-[#2b1b12] font-bold">
                        Manajemen Pesanan Masuk
                    </h1>
                    <p class="mono text-xs text-[#8A7A68] mt-0.5">
                        Kelola dan pantau seluruh pesanan yang masuk dari pelanggan secara real-time.
                    </p>
                </div>
            ...
            <div class="pt-4 border-t border-dashed border-[#2b1b12]/15 space-y-3">
                <div class="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <button v-if="dateFilter !== 'ALL'" type="button"
                        class="mono label-xs text-[#9b3a2e] underline" @click="resetDateFilter">
                        Reset filter
                    </button>
                </div>
            ...
            <div v-if="reqToReject"
                ...
                <div class="ticket-card w-full max-w-sm p-6 space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea v-model="rejectReason" rows="2" maxlength="300"
                            placeholder="Misal: stok habis, salah pesan..."
...
function selectDateOption(value) {
    ...
    // Untuk CUSTOM, tunggu user isi tanggal (lihat watcher di bawah)
}
...
// Rentang tanggal aktif dalam format YYYY-MM-DD, dihitung dari preset atau input kustom
